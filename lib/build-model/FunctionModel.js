...
FunctionModel.make = function(pos) {
	...
	var res = FunctionModel.cache[pos.start_offset] || (FunctionModel.cache[pos.start_offset] = new FunctionModel(pos.start_offset));
	add(res.source_positions, pos.start_offset);
	return res;
};
